...
public class demo4 {
    ...
    public static boolean condition(int[][] arraylist,int i){
        int sum =0;
        if ((arraylist[i][0] + arraylist[i][1] + arraylist[i][2] + arraylist[i][3]+ arraylist[i][4] == 0) //Horizontal line
            || (arraylist[0][i] + arraylist[1][i] + arraylist[2][i] + arraylist[3][i] + arraylist[4][i] == 0) //Vertical line
            || (arraylist[0][0] + arraylist[1][1] + arraylist[2][2] + arraylist[3][3] +  arraylist[4][4] == 0)  //Slash line
            || (arraylist[0][4] + arraylist[1][3] + arraylist[2][2] + arraylist[3][1] + arraylist[4][0] == 0) ){//Slash line
            return true;
        }else{
            return false;
        }
